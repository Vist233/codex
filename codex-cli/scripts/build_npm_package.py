#!/usr/bin/env python3
"""Stage and optionally package the @zhangyvjing/infinity-codex npm module."""
...
CODEX_NPM_NAME = "@zhangyvjing/infinity-codex"

# `npm_name` is the local optional-dependency alias consumed by `bin/codex.js`.
# Platform aliases point to the same scoped package with per-platform versions.
CODEX_PLATFORM_PACKAGES: dict[str, dict[str, str]] = {
    "codex-linux-x64": {
        "npm_name": "@zhangyvjing/infinity-codex-linux-x64",
        "npm_tag": "linux-x64",
    ...
    "codex-linux-arm64": {
        "npm_name": "@zhangyvjing/infinity-codex-linux-arm64",
        "npm_tag": "linux-arm64",
    ...
    "codex-darwin-x64": {
        "npm_name": "@zhangyvjing/infinity-codex-darwin-x64",
        "npm_tag": "darwin-x64",
    ...
    "codex-darwin-arm64": {
        "npm_name": "@zhangyvjing/infinity-codex-darwin-arm64",
    ...
    "codex-win32-x64": {
        "npm_name": "@zhangyvjing/infinity-codex-win32-x64",
        "npm_tag": "win32-x64",
    ...
    "codex-win32-arm64": {
        "npm_name": "@zhangyvjing/infinity-codex-win32-arm64",
        "npm_tag": "win32-arm64",
