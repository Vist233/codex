#!/usr/bin/env python3
"""Stage and optionally package the @infinity/codex npm module."""
...
CODEX_PLATFORM_PACKAGES: dict[str, dict[str, str]] = {
    ...
    "codex-linux-arm64": {
        "npm_name": "@infinity/codex-linux-arm64",
        "npm_tag": "linux-arm64",
    ...
    "codex-darwin-x64": {
        "npm_name": "@infinity/codex-darwin-x64",
        "npm_tag": "darwin-x64",
    ...
    "codex-darwin-arm64": {
        "npm_name": "@infinity/codex-darwin-arm64",
    ...
    "codex-win32-x64": {
        "npm_name": "@infinity/codex-win32-x64",
        "npm_tag": "win32-x64",
    ...
    "codex-win32-arm64": {
        "npm_name": "@infinity/codex-win32-arm64",
        "npm_tag": "win32-arm64",
